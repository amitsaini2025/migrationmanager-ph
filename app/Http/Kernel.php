...
class Kernel extends HttpKernel
{
    ...
    protected $middlewareGroups = [
        'web' => [
            ...
            \App\Http\Middleware\SetSecureSessionCookies::class, // Auto-detect HTTPS and set secure cookies
        ...
        'api' => [
		    //HandleCors::class, // <-- Add this line
            'throttle:60,1',
            'bindings',
        ],
    ];
    ...
    protected $middlewareAliases = [
        ...
        'reverb.lab.env.auto' => \App\Http\Middleware\ReverbLabEnvAutoLogin::class,
    ];
    ...
    protected $middlewarePriority = [
        \Illuminate\Session\Middleware\StartSession::class,
        \Illuminate\View\Middleware\ShareErrorsFromSession::class,
        \App\Http\Middleware\ReverbLabEnvAutoLogin::class,
