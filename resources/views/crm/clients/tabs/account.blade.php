@php
    $accountTabFragmentUrl = ! empty($encodeId)
        ? route('clients.detail.account-tab', array_filter([
            'client_id' => $encodeId,
                    ...
                    <tbody class="productitemList">
                        ...
                        <tr class="drow_account_ledger ledger-row {{$rowClass}}" data-type="{{$rec_val->client_fund_ledger_type}}" data-matterid="{{$rec_val->client_matter_id}}" data-trans-date="<?php echo htmlspecialchars($rec_val->trans_date, ENT_QUOTES, 'UTF-8'); ?>">
                            ...
                            <td class="type-cell" style="text-align: left; vertical-align: middle;">
                                ...
                                <?php
                                if (! empty($rec_val->account_inline_doc_url)) { ?>
                                        <a target="_blank" title="See Attached Document" class="link-primary" href="<?php echo $rec_val->account_inline_doc_url;?>">@icon('fa-file-pdf')</a>
                                <?php } ?>
                            </td>
                            ...
                            <td style="text-align: center; vertical-align: middle;">
                                <div class="dropdown d-inline-block">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="dropdownReceipt{{$rec_val->id}}">
                                        ...
                                        <div class="dropdown-divider"></div>
                                        <?php if (! empty($rec_val->account_dropdown_doc_url)) { ?>
                                        <a class="dropdown-item" href="<?php echo $rec_val->account_dropdown_doc_url; ?>" target="_blank">
                        ...
                        if(!empty($receipts_lists_office) && count($receipts_lists_office)>0 )
                        {
                            ...
                            <tr class="drow_account_office {{$unallocatedClass}}" 
                                ...
                                <td style="text-align: left; vertical-align: middle;">
                                    ...
                                    <?php
                                    if (! empty($off_val->account_inline_doc_url)) { ?>
                                            <br/>
                                            <a title="See Attached Document" target="_blank" class="link-primary" href="<?php echo $off_val->account_inline_doc_url;?>">@icon('fa-file-pdf') Document</a>
                                    <?php } ?>
                                </td>
                                <?php
                                $payClassMap = [
                                ...
                                <td class="description" style="text-align: left; vertical-align: middle;"><?php echo $off_val->description;?></td>
                                    ...
                                    <td style="text-align: center; vertical-align: middle;">
                                        ...
                                        <div class="dropdown-menu" aria-labelledby="dropdownOffice{{$off_val->id}}">
                                            ...
                                            <?php } ?>
                                            <div class="dropdown-divider"></div>
                                            <?php if (! empty($off_val->account_dropdown_doc_url)) { ?>
                                            <a class="dropdown-item" href="<?php echo $off_val->account_dropdown_doc_url; ?>" target="_blank">
                                                @icon('fa-file-alt') View Uploaded Receipt
                                            </a>
                                            <?php } ?>
